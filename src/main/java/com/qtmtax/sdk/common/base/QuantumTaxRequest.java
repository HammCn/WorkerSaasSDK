...
public class QuantumTaxRequest {
     ...
     * @return 当前实例
     */
    public final QuantumTaxRequest setAppKey(String appKey) {
        this.appKey = appKey;
        return this;
    }
     ...
     * @return 当前实例
     */
    public final QuantumTaxRequest setVersion(int version) {
     ...
     * @return 当前实例
     */
    public final QuantumTaxRequest setTimestamp(long timestamp) {
     ...
     * @return 当前实例
     */
    public final QuantumTaxRequest setContent(String content) {
     ...
     * @return 当前实例
     */
    public final QuantumTaxRequest setNonce(String nonce) {
        this.nonce = nonce;
        return this;
    }
     ...
     * @return 当前实例
     */
    public final QuantumTaxRequest setSignature(String signature) {
